...
public class N5_7X3 extends MTSGarminWorkout {
    public static final String NAME = "N5-7x3";

    public N5_7X3(Long workoutSerial) {
        super();
        ...
        3 series de 7xs seguidas e ininterruptas de 30seg a N5 (quase no máximo) 
        ...
        w.addStep(new WorkoutStepRepeat(w.getTotalSteps() - 1, 7));
