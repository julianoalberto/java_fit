...
public class N5_30_30_10X3 extends MTSGarminWorkout {
    public static final String NAME = "N5-30-30-10X3";
    private static final int REPETITIONS = 10;

    public N5_30_30_10X3(Long workoutSerial) {
        super();
        ...
        w.addStep(new WorkoutStepRepeat(w.getTotalSteps() - 1, REPETITIONS));
