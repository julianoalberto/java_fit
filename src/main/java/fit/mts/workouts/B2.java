...
public class B2 extends MTSGarminWorkout {
    public static final String NAME = "B2";

    public B2(Long workoutSerial) {
        super();
        ...
        // 6xs 4mn N3-55rpm a subir / 3mn N1-85rpm
        w.addStep(new WorkoutStepZoneMinutes(N3_RED, 4, "55 RPM UP"));
