...
public class N5_30_30_8X3 extends MTSGarminWorkout {
    public static final String NAME = "N5-30-30-8X3";

    public N5_30_30_8X3(Long workoutSerial) {
        super();
        ...
        w.addStep(new WorkoutStepRepeat(w.getTotalSteps() - 1, 8));
